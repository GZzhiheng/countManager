...
$(document).ready(function () {
    var table = $('#alarmTable').dataTable({
        ...
        "ajax": {
            "url": window.host + "/alert/alertTriggerRecord/list.json",
            "type": "POST",
        ...
        "columns": [
            ...
            {"data": "settingDetailName", searcher: false, orderable: true},
            {
                ...
                "render": function (data, type, full) {
                    ...
                    switch (full.settingDetailStatus) {
                        case "0":
                            settingDetailStatusCN = "<span class='alarmLevel' data-status='0' style='color:green'>关注</span>";
                            break;
                        case "1":
                            settingDetailStatusCN = "<span class='alarmLevel' data-status='1' style='color:orange'>重要</span>";
                            break;
                        case "2":
                            settingDetailStatusCN = "<span class='alarmLevel font-bold' data-status='2' style='color:red'>紧急</span>";
                            break;
                    }
            ...
            },
            {
                ...
                orderable: false,
                "render": function (data, type, full) {
                    return "<a href='#" + window.host + "/alert/alertTriggerRecord/update?id=" + full.id + "'>详情</a>";
                }
            }
        ]
    });
